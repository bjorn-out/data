...
- are aware of the many tools that can help you with version management, correctness testing and performing code reviews

## Prerequisites

This course assumes that you have experience using Python and you finished the course Scientific Programming 2.
...
This second half of the platforms course consists of three modules.

You pass the course by:
1. having sufficiently completed the three modules of Scientific Programming 2
2. submitting fully working solutions to the three Data Processing modules
3. passing the oral exam at the end of the course

Your grade will be determined by the grades for the three Data Processing modules. We will evaluate the following criteria:

- TBD

The three modules weigh equally in your final grade.

## Exam

At the end of the course, you must pass a final oral exam about the Scientific Programming 2 modules and the Data Processing modules. You will discuss these modules and your solutions with the teacher.

The exams will take place between 22 March and 26 March. Individual appointments will be made in due course. The exam is graded pass/fail.
...
| Module         | Deadline        |
|----------------|-----------------|
| Acquisition    | Fri 5 Mar 2021  |
| Transformation | Fri 12 Mar 2021 |
| Visualization  | Fri 19 Mar 2021 |
